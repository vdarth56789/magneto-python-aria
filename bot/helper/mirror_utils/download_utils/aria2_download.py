...
class AriaDownloadHelper(DownloadHelper):
    ...
    def __onDownloadStarted(self, api, gid):
        ...
        if STOP_DUPLICATE_MIRROR:
          ...
          if smsg:
              dl.getListener().onDownloadError(f'😡😡 File is Already Available in GDrive. This Download has been Stopped.\n\n')
              sendMarkup(" Here is the File 👇👇", dl.getListener().bot, dl.getListener().update, button)
